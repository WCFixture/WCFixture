    ...
    <Flex h="70vh" w="80vw" direction={'row'}>
      <Flex direction={'column'} justifyContent="space-around">
        {matches
          ?.filter(
            (m) =>
              m.date == '2022-12-03T00:00:00.000Z' ||
              m.date == '2022-12-05T00:00:00.000Z'
          )
          .map((m) => {
      ...
      <Flex ml="1vw" mr="1%" direction={'column'} justifyContent="space-around">
        {matches
          ?.filter((m) => m.date == '2022-12-09T00:00:00.000Z')
          .map((m) => {
            return <PlayOffMatch match={m} setMatch={setMatch}></PlayOffMatch>;
          })}
      </Flex>
      ...
      <Flex ml="1%" mr="1%" direction={'column'} justifyContent="space-around">
        {matches
          ?.filter((m) => m.date == '2022-12-18T00:00:00.000Z')
          .map((m) => {
            return <PlayOffMatch match={m}></PlayOffMatch>;
          })}
      </Flex>
      ...
      <Flex ml="1%" mr="1%" direction={'column'} justifyContent="space-around">
        {matches
          ?.filter((m) => m.date == '2022-12-10T00:00:00.000Z')
          .map((m) => {
            return <PlayOffMatch match={m} setMatch={setMatch}></PlayOffMatch>;
          })}
      </Flex>
      <Flex direction={'column'} justifyContent="space-around">
        {matches
          ?.filter(
            (m) =>
              m.date == '2022-12-04T00:00:00.000Z' ||
              m.date == '2022-12-06T00:00:00.000Z'
          )
          .map((m) => {
            return <PlayOffMatch match={m} setMatch={setMatch}></PlayOffMatch>;
          })}
